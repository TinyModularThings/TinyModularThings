...
public class BasicRecipes
{
	...
	private static void loadElectronicsRecipes(PathProxy pp)
	{
		...
		pp.addRecipe(new ItemStack(APIItems.damageableCircuits.get("StorageLogicDiamond")), new Object[] {"XYX", "CVC", "XBX", 'X', new ItemStack(APIItems.circuits, 1, 1), 'V', new ItemStack(APIItems.circuits, 1, 2), 'C', Item.redstoneRepeater, 'B', Block.pistonStickyBase, 'Y', Item.netherStar });
		pp.addRecipe(new ItemStack(APIItems.damageableCircuits.get("StorageLogicDiamond")), new Object[] {"XYX", "CVC", "XBX", 'X', new ItemStack(APIItems.circuits, 1, 1), 'V', new ItemStack(APIItems.circuits, 1, 2), 'C', Item.redstoneRepeater, 'B', Block.pistonStickyBase, 'Y', Block.blockEmerald });
	}
	
	private static void loadGearRecipes(PathProxy pp)
	{
		// Gear Parts
