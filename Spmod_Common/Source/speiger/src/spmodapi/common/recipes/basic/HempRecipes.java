	...
	public static void load(PathProxy pp)
	{
		for(int i = 1;i<17;i++)
		{
			for(int z = 0;z<17;z++)
			{
				...
				pp.addSRecipe(new ItemStack(APIItems.hempPlates[i].itemID, 8, APIItems.hempPlates[i].getItemDamage()), new Object[]{new ItemStack(Item.dyePowder, 1, i-1), g, g, g, g, g, g, g, g});
			...
			pp.addRecipe(new ItemStack(APIBlocks.hempBrick, 8, i-1), new Object[]{"XXX", "XYX", "XXX", 'X', new ItemStack(APIBlocks.hempBlock, 1, i-1), 'Y', Block.stone});
			pp.addRecipe(new ItemStack(APIBlocks.hempBrick, 4, i-1), new Object[]{" X ", "XYX", " X ", 'X', new ItemStack(APIBlocks.hempBlock, 1, i-1), 'Y', Block.stone});
			...
			pp.addRecipe(new ItemStack(APIBlocks.hempBrickPlated, 8, i-1), new Object[]{"XXX", "XYX", "XXX", 'X', new ItemStack(APIBlocks.hempBlockPlated, 1, i-1), 'Y', Block.stone});
			pp.addRecipe(new ItemStack(APIBlocks.hempBrickPlated, 4, i-1), new Object[]{" X ", "XYX", " X ", 'X', new ItemStack(APIBlocks.hempBlockPlated, 1, i-1), 'Y', Block.stone});
			pp.addRecipe(new ItemStack(APIBlocks.hempBlock, 8, i-1), new Object[]{"XXX", "XYX", "XXX", 'X', new ItemStack(APIBlocks.hempBlockBase, 1, 0), 'Y', new ItemStack(Item.dyePowder, 1, i-1)});
			pp.addRecipe(new ItemStack(APIBlocks.hempBlockPlated, 8, i-1), new Object[]{"XXX", "XYX", "XXX", 'X', new ItemStack(APIBlocks.hempBlockBase, 1, 1), 'Y', new ItemStack(Item.dyePowder, 1, i-1)});
			pp.addRecipe(new ItemStack(APIBlocks.hempBrick, 8, i-1), new Object[]{"XXX", "XYX", "XXX", 'X', new ItemStack(APIBlocks.hempBlockBase, 1, 2), 'Y', new ItemStack(Item.dyePowder, 1, i-1)});
			pp.addRecipe(new ItemStack(APIBlocks.hempBrickPlated, 8, i-1), new Object[]{"XXX", "XYX", "XXX", 'X', new ItemStack(APIBlocks.hempBlockBase, 1, 3), 'Y', new ItemStack(Item.dyePowder, 1, i-1)});
		...
		pp.addRecipe(new ItemStack(APIItems.hempPlates[0].itemID, 4, APIItems.hempPlates[0].getItemDamage()), new Object[]{"XX", "XX", 'X', APIItems.hemp});
		pp.addRecipe(new ItemStack(APIBlocks.hempBlockBase, 1, 0), new Object[]{"XX", "XX", 'X', APIItems.hempPlates[0]});
		pp.addRecipe(new ItemStack(APIBlocks.hempBlockBase, 4, 2), new Object[]{" X ", "XYX", " X ", 'X', new ItemStack(APIBlocks.hempBlockBase, 1, 0), 'Y', Block.stone});
		pp.addRecipe(new ItemStack(APIBlocks.hempBlockBase, 4, 3), new Object[]{" X ", "XYX", " X ", 'X', new ItemStack(APIBlocks.hempBlockBase, 1, 1), 'Y', Block.stone});
		pp.addRecipe(new ItemStack(APIBlocks.hempBlockBase, 8, 2), new Object[]{"XXX", "XYX", "XXX", 'X', new ItemStack(APIBlocks.hempBlockBase, 1, 0), 'Y', Block.stone});
		pp.addRecipe(new ItemStack(APIBlocks.hempBlockBase, 8, 3), new Object[]{"XXX", "XYX", "XXX", 'X', new ItemStack(APIBlocks.hempBlockBase, 1, 1), 'Y', Block.stone});
