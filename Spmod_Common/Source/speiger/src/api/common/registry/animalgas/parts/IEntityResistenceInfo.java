...
public interface IEntityResistenceInfo extends IEntityInfo
{
	 ...
	 */
	public Resistence.ResistanceType getResistanceType(EntityAgeable par1);
	
	/**
	 * Some Entities have bigger healing Abilities then other so that also flow into the Things
	 */
