...
public interface IRotorItem
{
	...
	/**
	 * This function will call the damage stuff. If the rotor is advanced the
	 * damage modifires will be based on the Tiers. (if rotor tier is lower as
	 * the Windmill damage will higher and opposite) return false to make normal
	 * damage. it gains ever 64 ticks (3,2 sek) 1 damage.
	 * 
	 * @ItemStack the rotor Itself.
