...
public class BlockWindmill extends BlockContainer
{
	...
	{
		// Accessing simply a Fake TileEntity that does not getUpdated, because
		// its not in the World, That saves a lot of coding because i need to
		// make the textures only 1 time in the TileEntity :P
