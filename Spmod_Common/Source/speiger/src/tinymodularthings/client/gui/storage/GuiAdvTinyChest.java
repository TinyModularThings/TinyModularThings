...
public class GuiAdvTinyChest extends GuiInventoryCore
{
	ISharedInventory tile;
	InventoryPlayer inv;
	
	public GuiAdvTinyChest(InventoryPlayer par1, ISharedInventory par2)
	{
	...
	{
		String s = LanguageRegister.getLanguageName(this, "tiny.chest.adv", getCore());
		if (tile.isEntity())
		{
